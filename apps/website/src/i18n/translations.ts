...
const ui = {
  en: {
    ...
    "worldmap.moreRecipes": "More recipes from {region}",
    "worldmap.moreMixtures": "More mixtures from {region}",
    "worldmap.heading": "Explore by region",
    ...
    "ingredient.section.description": "Overview",
    "ingredient.sources": "Sources",
    "ingredient.imageCredit": "Image credit",
  ...
  de: {
    ...
    "worldmap.moreRecipes": "Mehr Rezepte aus {region}",
    "worldmap.moreMixtures": "Mehr Mischungen aus {region}",
    "worldmap.heading": "Nach Region entdecken",
    ...
    "ingredient.section.description": "Überblick",
    "ingredient.sources": "Quellen",
    "ingredient.imageCredit": "Bildnachweis",
    "ingredient.liability":
